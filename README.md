...
- [智慧交通场景应用](#--------)
  ...
  * [部署](#--)
    ...
    + [预训练权重](#-----)
    + [Windows部署](#windows--)
        * [1.自行安装CUDA和CUDNN](#1----cuda-cudnn)
        * [2.在项目根目录执行如下安装命令](#2--------------)
        * [3.安装指定版本的opencv](#3-------opencv)
        * [4.安装支持RTMP的Nginx](#4----rtmp-nginx)
    + [Linux部署](#linux--)
      - [基于Docker部署](#--docker--)
      - [自行编译环境部署](#--------)
        * [1.自行安装CUDA和CUDNN](#1----cuda-cudnn-1)
        * [2.在项目根目录执行如下安装命令](#2---------------1)
        * [3.安装指定版本的opencv](#3-------opencv-1)
        * [4.编译支持RTMP的Nginx](#4----rtmp-nginx)
  * [使用](#--)
    + [开启后端服务器](#-------)
  * [附录](#--)
    + [Opencv编译说明](#opencv----)
